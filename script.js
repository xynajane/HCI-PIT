document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateGallery() {
        ...
        gallery.innerHTML = `
            <div class="image-container" id="image${currentIndex + 1}">
                <img src="${currentImage}" alt="Image ${currentIndex + 1}" id="slide" />
                <p><b>${currentDescription.split(',')[0]}</b></p>
            </div>`;
    ...
    // Automatically move to the next slide every 2 seconds (adjusted for testing purposes)
